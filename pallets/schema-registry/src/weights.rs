...
//! Autogenerated weights for `pallet_schema_registry`
//!
...
/// Weight functions for `pallet_schema_registry`.
...
impl<T: frame_system::Config> WeightInfo for SchemaRegistryWeightInfo<T> {
	...
	// Storage: Timestamp Now (r:1 w:0)
	// Storage: SchemaRegistry CredentialStore (r:1 w:1)
	/// The range of component `s` is `[0, 100]`.
	fn create_credential() -> Weight {
